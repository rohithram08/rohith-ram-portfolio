...
export default function Contact() {
  return (
    <>
      <SEOHead
        title="Contact"
        description={`Get in touch with ${developerInfo.name} for collaboration and opportunities. ${developerInfo.availability}`}
      />
        ...
        <section className="py-24 md:py-32 px-6 lg:px-8 border-b border-border">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <motion.div initial={{ opacity: 0.8, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              ...
              <p className="text-lg md:text-xl text-muted-foreground font-light tracking-wide">Let's discuss opportunities and collaborations</p>
            </motion.div>
          </div>
        </section>
              ...
              <motion.div className="space-y-6" initial={{ opacity: 0.8, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4 }}>
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground font-light">
                    Fill out the form below and I'll get back to you. {developerInfo.availability}
                  </p>
                </div>
                <ContactForm />
              </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <a href={`mailto:${developerInfo.email}`} className="text-base md:text-lg font-light hover:text-muted-foreground transition-colors">{developerInfo.email}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-sm bg-accent"><Phone className="size-5 text-muted-foreground" /></div>
                    <div className="space-y-1">
                      <p className="text-sm font-light tracking-wide text-muted-foreground">Phone</p>
                      <a href={`tel:${developerInfo.phone}`} className="text-base md:text-lg font-light hover:text-muted-foreground transition-colors">{developerInfo.phone}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-base md:text-lg font-light">{developerInfo.location}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
